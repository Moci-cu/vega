...
MaterialSymbol {
    ...
    color: true ? Appearance.colors.colOnPrimary : Appearance.colors.colOnLayer1
    ...
    Rectangle {
        ...
        color: true ? Appearance.colors.colOnPrimary : Appearance.colors.colOnLayer0
        z: 1
        ...
        StyledText {
            ...
            color: true ? Appearance.colors.colPrimary : Appearance.colors.colLayer0
