...
Item {
    id: root
    Component.onCompleted: End4PcSpectrum.users++
    Component.onDestruction: End4PcSpectrum.users = Math.max(0, End4PcSpectrum.users - 1)
    property bool vertical: Config.options.bar.vertical
    property bool isMaterial: true
    property bool mirrored: false
    readonly property MprisPlayer activePlayer: MprisController.activePlayer
    readonly property bool isPlaying: activePlayer?.isPlaying ?? false
    readonly property list<real> points: End4PcSpectrum.points
