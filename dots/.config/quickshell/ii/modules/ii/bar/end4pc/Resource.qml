...
Item {
    ...
    implicitWidth:  vertical ? 32 : (resourceRowLayout.x < 0 ? 0 : resourceRowLayout.implicitWidth)
    implicitHeight: vertical ? resourceProgress.implicitHeight : 40
    ...
    Loader {
        ...
        visible: active
        anchors.centerIn: parent
        sourceComponent: true ? filledStyle : outlineStyle
    }
